...
section). For the helper functions that complete the workflow –
reporting sample sizes, computing age, decoding codes, scoring
comorbidity, and building episodes of care – see the data wrangling
vignette (`vignette("wrangling")`).
