...
#> ℹ Of the 19 clients in the input, 12 were flagged as 0 by restricting that each client must have 2 records that were at least 7 days apart within 30 days
#> # A tibble: 30 × 6
#>    clnt_id service_dt diagx diagx_1 diagx_2 flag_restrict_date
#>      <int> <date>     <chr> <chr>   <chr>                <dbl>
#>  1       3 2020-01-30 i     a       n                        0
#>  2       4 2020-01-31 o     d       y                        0
#>  3       5 2020-01-27 u     v       k                        0
#>  4       7 2020-01-21 v     a       w                        0
#>  5       8 2020-01-26 k     g       NA                       0
#>  6       9 2020-01-27 t     l       g                        0
#>  7      10 2020-01-03 q     t       NA                       1
#>  8      10 2020-01-29 r     l       f                        0
#>  9      11 2020-01-22 f     x       x                        0
#> 10      12 2020-01-20 r     n       t                        0
#> # ℹ 20 more rows
```
