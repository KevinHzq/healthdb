...
test_comorbidity <- function(n_row = 10, n_col = 31, n_clnt = 3, icd10 = TRUE) {
  ...
  if (icd10) {
    ...
    # codes that match multiple categories under prefix matching are left out
    # (e.g., "40201" is in chf and its prefix "402" is in hptn_c per Quan et
    # al.) because the synthetic answer assumes one category per code
    code_list <- list(
      c(
        "39891", "4254", "4257", "4258", "4259", "428"
      ),
      c(
      ...
      c("401"),
      c("402", "403", "404", "405"),
      c("342", "343", "3440", "3441", "3442", "3443", "3444", "3445", "3446", "3449"),
      c(
        "3319", "3320", "3321", "3334", "3335", "33392", "334", "335", "3362", "340", "341",
        "345", "3481", "3483", "7803", "7843"
      ),
      c(
        "490", "491", "492", "493", "494", "495", "496", "500", "501", "502",
      ...
      c("2938", "295", "29604", "29614", "29644", "297", "298"),
